...
const handleSubmit = async (e) => {
  ...
  const roleConfig = {
    student: {
      emailPlaceholder: "student.id@university.edu",
    },
    teacher: {
      emailPlaceholder: "faculty.name@university.edu",
    },
  };
        ...
        <div className="w-full md:w-1/2 flex flex-col justify-between max-w-lg space-y-8">
          <div>
            ...
            <p className="mt-4 text-slate-500 text-base sm:text-lg font-normal">
              Register to access your courses, department records, and campus portal tools.
            </p>
          </div>
        ...
        <div className="w-full md:w-1/2 max-w-md">
          <div className="bg-white rounded-3xl shadow-2xl shadow-indigo-100/50 p-8 sm:p-10 border border-slate-100">
            ...
            <div className="mb-6">
              ...
              <p className="text-slate-400 text-sm mt-1">Select your account role to continue</p>
            </div>
            ...
            <form className="space-y-4" onSubmit={handleSubmit}>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  onChange={handleChange}
                  placeholder={roleConfig[formData.role].emailPlaceholder}
                  className="w-full pl-10 pr-4 py-3 bg-slate-50/50 border border-slate-200 rounded-xl text-sm placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 transition-all"
                />
              </div>
              {errors.email && (
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                ...
                <div className="relative flex">
                  ...
                  <div className="absolute inset-y-0 left-9 flex items-center pointer-events-none text-xs font-semibold text-slate-400 border-r border-slate-200 pr-2">
                    +91
                  </div>
                  <input
                    type="tel"
