...
const TeacherFilters = ({search , setSearch , department , setDepartment ,designation ,setDesignation , status , setStatus , resetFilters}) => {
  return (
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-5 gap-4">
        ...
        {/* Department */}
          ...
          <select
            ...
            className="px-4 py-3 rounded-xl border border-slate-200 bg-slate-50 focus:outline-none focus:ring-2 focus:ring-indigo-500 text-sm"
          >
