...
const DeleteModal = ({
  ...
  if (!isOpen || !data || !config) return null;
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-6">
      ...
      {/* Modal */}
      <div className="relative z-10 flex w-full max-w-3xl max-h-[96vh] flex-col overflow-hidden rounded-3xl bg-white shadow-2xl">
        
        {/* Header */}
        <div className="relative border-b border-slate-200 px-8 py-6">
          <button
            onClick={onCancel}
            className="absolute right-6 top-6 rounded-xl p-2 text-slate-500 hover:bg-slate-100 transition"
          >
            <X size={20} />
          </button>
