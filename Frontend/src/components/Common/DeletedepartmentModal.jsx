            ...
            <div>
              ...
              <div className="mt-2 flex items-center gap-2">
                ...
                <span className="rounded-full bg-indigo-50 px-3 py-1 text-sm font-medium text-indigo-600">
                  {department?.hod_name?.trim() || "No HOD Assigned"}
                </span>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="mt-2 text-sm leading-6 text-red-600">
                  Deleting this department will permanently remove all department
                  information from the system.
                </p>

                <ul className="mt-4 list-disc space-y-1 pl-5 text-sm text-red-600">
                    <li>Department information</li>
                    <li>Head of Department assignment</li>
                    <li>Department records</li>
                    <li>Related department data (if any)</li>
                </ul>
